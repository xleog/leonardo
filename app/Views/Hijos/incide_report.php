...
<div class="modal modal-blur fade" tabindex="-1" role="dialog" aria-hidden="true" id="mdlreport" name="mdlreport">
...
<script src="<?= base_url('public/dist/js/paginas/incide_report.js') ?>" defer></script>
